...
public class QuestRealmProxy extends com.szb.ARMODULE.model.database.Quest
    ...
    private ProxyState<com.szb.ARMODULE.model.database.Quest> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.szb.ARMODULE.model.database.Quest>(this);
    ...
    @SuppressWarnings("cast")
    public static com.szb.ARMODULE.model.database.Quest createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.szb.ARMODULE.model.database.Quest obj = realm.createObjectInternal(com.szb.ARMODULE.model.database.Quest.class, true, excludeFields);
    ...
    public static com.szb.ARMODULE.model.database.Quest createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        com.szb.ARMODULE.model.database.Quest obj = new com.szb.ARMODULE.model.database.Quest();
        reader.beginObject();
    ...
    public static com.szb.ARMODULE.model.database.Quest copyOrUpdate(Realm realm, com.szb.ARMODULE.model.database.Quest object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.szb.ARMODULE.model.database.Quest) cachedRealmObject;
        } else {
            return copy(realm, object, update, cache);
        }
    }

    public static com.szb.ARMODULE.model.database.Quest copy(Realm realm, com.szb.ARMODULE.model.database.Quest newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.szb.ARMODULE.model.database.Quest) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.szb.ARMODULE.model.database.Quest realmObject = realm.createObjectInternal(com.szb.ARMODULE.model.database.Quest.class, false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.szb.ARMODULE.model.database.Quest object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.szb.ARMODULE.model.database.Quest.class);
        long tableNativePtr = table.getNativeTablePointer();
        QuestColumnInfo columnInfo = (QuestColumnInfo) realm.schema.getColumnInfo(com.szb.ARMODULE.model.database.Quest.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativeTablePointer();
        QuestColumnInfo columnInfo = (QuestColumnInfo) realm.schema.getColumnInfo(com.szb.ARMODULE.model.database.Quest.class);
        com.szb.ARMODULE.model.database.Quest object = null;
        while (objects.hasNext()) {
            object = (com.szb.ARMODULE.model.database.Quest) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.szb.ARMODULE.model.database.Quest object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.szb.ARMODULE.model.database.Quest.class);
    ...
    public static com.szb.ARMODULE.model.database.Quest createDetachedCopy(com.szb.ARMODULE.model.database.Quest realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.szb.ARMODULE.model.database.Quest unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.szb.ARMODULE.model.database.Quest)cachedObject.object;
            } else {
                unmanagedObject = (com.szb.ARMODULE.model.database.Quest)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.szb.ARMODULE.model.database.Quest();

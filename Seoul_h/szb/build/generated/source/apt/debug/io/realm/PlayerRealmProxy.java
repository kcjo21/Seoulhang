...
public class PlayerRealmProxy extends com.szb.szb.model.database.Player
    ...
    private ProxyState<com.szb.szb.model.database.Player> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.szb.szb.model.database.Player>(this);
    ...
    @SuppressWarnings("cast")
    public static com.szb.szb.model.database.Player createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.szb.szb.model.database.Player obj = realm.createObjectInternal(com.szb.szb.model.database.Player.class, true, excludeFields);
        if (json.has("id")) {
            if (json.isNull("id")) {
    ...
    public static com.szb.szb.model.database.Player createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        com.szb.szb.model.database.Player obj = new com.szb.szb.model.database.Player();
        reader.beginObject();
    ...
    public static com.szb.szb.model.database.Player copyOrUpdate(Realm realm, com.szb.szb.model.database.Player object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.szb.szb.model.database.Player) cachedRealmObject;
        } else {
            return copy(realm, object, update, cache);
        }
    }

    public static com.szb.szb.model.database.Player copy(Realm realm, com.szb.szb.model.database.Player newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.szb.szb.model.database.Player) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.szb.szb.model.database.Player realmObject = realm.createObjectInternal(com.szb.szb.model.database.Player.class, false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.szb.szb.model.database.Player object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.szb.szb.model.database.Player.class);
        long tableNativePtr = table.getNativeTablePointer();
        PlayerColumnInfo columnInfo = (PlayerColumnInfo) realm.schema.getColumnInfo(com.szb.szb.model.database.Player.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativeTablePointer();
        PlayerColumnInfo columnInfo = (PlayerColumnInfo) realm.schema.getColumnInfo(com.szb.szb.model.database.Player.class);
        com.szb.szb.model.database.Player object = null;
        while (objects.hasNext()) {
            object = (com.szb.szb.model.database.Player) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.szb.szb.model.database.Player object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.szb.szb.model.database.Player.class);
    ...
    public static com.szb.szb.model.database.Player createDetachedCopy(com.szb.szb.model.database.Player realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.szb.szb.model.database.Player unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.szb.szb.model.database.Player)cachedObject.object;
            } else {
                unmanagedObject = (com.szb.szb.model.database.Player)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.szb.szb.model.database.Player();

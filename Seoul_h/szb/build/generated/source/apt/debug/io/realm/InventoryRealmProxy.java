...
public class InventoryRealmProxy extends com.szb.szb.model.database.Inventory
    ...
    private ProxyState<com.szb.szb.model.database.Inventory> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.proxyState = new ProxyState<com.szb.szb.model.database.Inventory>(this);
    ...
    @SuppressWarnings("cast")
    public static com.szb.szb.model.database.Inventory createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        throws JSONException {
        final List<String> excludeFields = Collections.<String> emptyList();
        com.szb.szb.model.database.Inventory obj = realm.createObjectInternal(com.szb.szb.model.database.Inventory.class, true, excludeFields);
    ...
    public static com.szb.szb.model.database.Inventory createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        com.szb.szb.model.database.Inventory obj = new com.szb.szb.model.database.Inventory();
        reader.beginObject();
    ...
    public static com.szb.szb.model.database.Inventory copyOrUpdate(Realm realm, com.szb.szb.model.database.Inventory object, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        ...
        if (cachedRealmObject != null) {
            return (com.szb.szb.model.database.Inventory) cachedRealmObject;
        } else {
            return copy(realm, object, update, cache);
        }
    }

    public static com.szb.szb.model.database.Inventory copy(Realm realm, com.szb.szb.model.database.Inventory newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (com.szb.szb.model.database.Inventory) cachedRealmObject;
        } else {
            // rejecting default values to avoid creating unexpected objects from RealmModel/RealmList fields.
            com.szb.szb.model.database.Inventory realmObject = realm.createObjectInternal(com.szb.szb.model.database.Inventory.class, false, Collections.<String>emptyList());
    ...
    public static long insert(Realm realm, com.szb.szb.model.database.Inventory object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.szb.szb.model.database.Inventory.class);
        long tableNativePtr = table.getNativeTablePointer();
        InventoryColumnInfo columnInfo = (InventoryColumnInfo) realm.schema.getColumnInfo(com.szb.szb.model.database.Inventory.class);
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativeTablePointer();
        InventoryColumnInfo columnInfo = (InventoryColumnInfo) realm.schema.getColumnInfo(com.szb.szb.model.database.Inventory.class);
        com.szb.szb.model.database.Inventory object = null;
        while (objects.hasNext()) {
            object = (com.szb.szb.model.database.Inventory) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, com.szb.szb.model.database.Inventory object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy)object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy)object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(com.szb.szb.model.database.Inventory.class);
    ...
    public static com.szb.szb.model.database.Inventory createDetachedCopy(com.szb.szb.model.database.Inventory realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        com.szb.szb.model.database.Inventory unmanagedObject;
        if (cachedObject != null) {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (com.szb.szb.model.database.Inventory)cachedObject.object;
            } else {
                unmanagedObject = (com.szb.szb.model.database.Inventory)cachedObject.object;
                cachedObject.minDepth = currentDepth;
            }
        } else {
            unmanagedObject = new com.szb.szb.model.database.Inventory();

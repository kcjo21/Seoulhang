...
public class Quiz_Dragger extends SwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz__dragger);
        ...
        Submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                methods = new Methods();
                methods.progressON(Quiz_Dragger.this, getResources().getString(R.string.Loading)); //응답대기 애니메이션
                String answer="";
                ipm = new Ipm();
                String ip = ipm.getip();
                        ...
                        public void onResponse(Call<Integer> call, Response<Integer> response) {
                            switch (response.code()) {
                                case 200:
                                    ...
                                    AlertDialog.Builder alert = new AlertDialog.Builder(Quiz_Dragger.this);
                                    alert.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            dialog.dismiss();     //닫기
                                            Intent intent = new Intent(Quiz_Dragger.this,Home_Main.class);
